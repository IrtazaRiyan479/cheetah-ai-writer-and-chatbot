...
const RewriteFields = () => (
  <>
    ...
    <Grid size={{ xs: 12 }}>
      ...
      <TextField fullWidth size='small' placeholder='https://example.com/article' />
    </Grid>
    ...
    <Grid size={{ xs: 12 }}>
      <FormControlLabel control={<Switch defaultChecked />} label={<Typography className='font-medium text-textPrimary'>Enable Rewriting</Typography>} />
    </Grid>
    ...
    <Grid size={{ xs: 12 }} className='flex flex-col gap-2'>
      <FormControlLabel control={<Switch defaultChecked />} label={<Typography className='font-medium text-textPrimary'>Include External Links</Typography>} />
